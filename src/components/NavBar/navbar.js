  ...
  return (
    <nav className='navbar'>
      ...
      <div className="desktopMenu">
        ...
        <Link activeClass='active' to='skills' spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem">Tech Stack</Link>
      ...
      <button className="desktopMenuBtn" onClick={() => {
        ...
        <Link activeClass='active' to='skills' spy={true} smooth={true} offset={-50} duration={500} className="listItem" onClick={()=>setShowMenu(false)}>Tech Stack</Link>
